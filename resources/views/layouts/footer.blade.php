    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div data-aos="fade-up">
                ...
                <p class="text-blue-100 leading-relaxed mb-6">Himpunan Ahlussunnah untuk Masyarakat Islami. Membangun peradaban Islami melalui pendidikan, dakwah, dan aksi sosial.</p>
                ...
                <div class="flex gap-4">
                    <a href="https://www.facebook.com/hasmipusat" target="_blank" class="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center hover:bg-[#1877F2] hover:text-white transition-all duration-300 transform hover:-translate-y-1 group">
                        <i class="fab fa-facebook-f text-blue-100 group-hover:text-white"></i>
                    </a>
                    <a href="https://x.com/hasmipusat" target="_blank" class="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center hover:bg-black hover:text-white transition-all duration-300 transform hover:-translate-y-1 group border border-transparent hover:border-slate-700">
                        <i class="fab fa-twitter text-blue-100 group-hover:text-white"></i>
                    </a>
                    <a href="https://www.instagram.com/hasmipusat/" target="_blank" class="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center hover:bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] hover:text-white transition-all duration-300 transform hover:-translate-y-1 group">
                        <i class="fab fa-instagram text-blue-100 group-hover:text-white"></i>
                    </a>
                    <a href="https://www.youtube.com/@HasmiTV/featured" target="_blank" class="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center hover:bg-red-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 group">
            ...
            <div data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="https://www.hasmi.org/wp-content/uploads/2021/01/Profil.pdf" target="_blank" class="flex items-center gap-3 text-blue-100 hover:text-white group transition-colors p-3 rounded-xl hover:bg-white/10 border border-transparent hover:border-white/20">
                            <i class="fas fa-file-pdf text-red-400 text-xl group-hover:scale-110 transition-transform"></i>
                            <div>
                    ...
                    <li>
                        <a href="https://www.hasmi.org/wp-content/uploads/2020/08/e-HDH.pdf" target="_blank" class="flex items-center gap-3 text-blue-100 hover:text-white group transition-colors p-3 rounded-xl hover:bg-white/10 border border-transparent hover:border-white/20">
                            <i class="fas fa-book-open text-blue-300 text-xl group-hover:scale-110 transition-transform"></i>
                            <div>
                                <span class="block font-medium">E-Book HDH</span>
                                <span class="text-xs text-blue-200 group-hover:text-blue-100">Himpunan Doa Hisnul Muslim</span>
                            </div>
                        </a>
                    </li>
                </ul>
                ...
                <div class="bg-gradient-to-br from-blue-700/50 to-blue-800/70 lg:backdrop-blur-md rounded-2xl p-6 border border-blue-400/30 relative overflow-hidden group hover:border-blue-300/50 transition-all duration-500">
                    ...
                    <div class="relative z-10">
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h4 class="font-bold text-xl text-white mb-1"><i class="fas fa-mosque text-blue-300 mr-2"></i>Jadwal Sholat</h4>
                            ...
                            <div class="text-right">
                                ...
                                <div class="text-xs text-green-300 font-medium mt-1 animate-pulse" id="next-prayer-countdown">Menghitung...</div>
                            </div>
                        </div>
        ...
        <div class="border-t border-blue-500/40 pt-8 flex flex-col md:flex-row justify-between items-center text-blue-100 text-sm">
            ...
            try {
                ...
                if (data.code === 200) {
                    ...
                    for (const [name, time] of Object.entries(prayers)) {
                        ...
                        div.className = `sholat-item rounded-xl p-3 flex flex-col items-center justify-center border transition-all duration-300 ${name === nextPrayerName ? 'bg-blue-500 border-blue-300 shadow-lg shadow-blue-700/50 scale-105 z-10' : 'bg-blue-700/50 border-blue-500/60 hover:bg-blue-600/60'}`;
                        ...
                        document.getElementById('next-prayer-countdown').textContent = `Menuju ${nextPrayerName}: ${nextPrayerTime}`;
                         ...
                         Array.from(children).forEach(child => {
                             ...
                             if (nameSpan.textContent === nextPrayerName) {
                                 child.className = 'sholat-item rounded-xl p-3 flex flex-col items-center justify-center border transition-all duration-300 bg-blue-500 border-blue-300 shadow-lg shadow-blue-700/50 scale-105 z-10';
                                 child.innerHTML = `
