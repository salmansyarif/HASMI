...
<style>
    ...
    .prose p { margin-bottom: 1.5rem; color: #dbeafe; line-height: 1.8; }
        ...
        <div class="max-w-4xl mx-auto">
                ...
                @if($berita->video_url)
                    <div class="aspect-video w-full relative">
                        @if(Str::contains($berita->video_url, 'youtube.com') || Str::contains($berita->video_url, 'youtu.be'))
                            <iframe src="{{ str_replace('watch?v=', 'embed/', $berita->video_url) }}" 
            ...
            <div class="text-center pt-10 border-t border-blue-500/50" data-aos="fade-up">
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($berita->title) }}" target="_blank" class="w-12 h-12 rounded-full bg-sky-500 hover:bg-sky-400 flex items-center justify-center text-white transition-all transform hover:-translate-y-1 shadow-lg">
