        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        <!-- Legacy Media Position (Required by Controller) -->
                        <div class="hidden">
                        ...
                        <div>
                            ...
                            <select name="photo_position" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                                <option value="top" {{ old('photo_position') == 'top' ? 'selected' : '' }}>Atas (Hero)</option>
                                <option value="middle" {{ old('photo_position') == 'middle' ? 'selected' : '' }}>Tengah (Setelah Judul)</option>
                                <option value="bottom" {{ old('photo_position') == 'bottom' ? 'selected' : '' }}>Bawah (Setelah Konten)</option>
                                <option value="none" {{ old('photo_position') == 'none' ? 'selected' : '' }}>Tidak Ditampilkan</option>
                            </select>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="show_thumbnail_in_list" value="1" class="sr-only peer" {{ old('show_thumbnail_in_list', true) ? 'checked' : '' }}>
                                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="show_thumbnail_in_detail" value="1" class="sr-only peer" {{ old('show_thumbnail_in_detail', true) ? 'checked' : '' }}>
                                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                        </div>
                    </div>
