...
@section('title', 'Tambah Berita - Admin HASMI')
@section('page-title', 'Tambah Berita Baru')
@section('page-subtitle', 'Buat artikel berita atau informasi terkini')
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 space-y-6">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required
                       ...
                       placeholder="Contoh: Kunjungan Dakwah ke Pelosok Desa">
                @error('title')
            ...
            <div>
                ...
                <textarea id="short_description" name="short_description" rows="3"
                          ...
                          placeholder="Ringkasan berita (akan muncul di daftar berita)...">{{ old('short_description') }}</textarea>
            ...
            <div>
                ...
                <textarea id="content" name="content" rows="10"
                          ...
                          placeholder="Tulis isi berita lengkap di sini...">{{ old('content') }}</textarea>
                @error('content')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <p class="text-gray-500 text-xs mt-1">
                    Gambar utama yang muncul di list berita. Format: JPG, PNG, WEBP. Maks 2MB.
                </p>
                @error('thumbnail')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                <label for="photos" class="block text-sm font-semibold text-gray-700 mb-2">
                    <i class="fas fa-images text-blue-600 mr-1"></i> Galeri Foto Dokumentasi
                </label>
                ...
                <p class="text-gray-500 text-xs mt-1">
                    Bisa pilih banyak foto sekaligus. Akan ditampilkan sebagai galeri/slider di detail berita.
                </p>
                @error('photos.*')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="border-t border-gray-200 pt-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">
                    <i class="fas fa-video text-blue-600 mr-2"></i>Video Dokumentasi (Opsional)
                </h3>
