...
@section('page-subtitle', 'Edit informasi akun administrator')
...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-800">Edit Akun: {{ $admin->name }}</h2>
        </div>
        ...
        <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="border-t border-gray-100 pt-6">
                <h3 class="text-md font-bold text-gray-800 mb-4">Ubah Password (Opsional)</h3>
